...
phyloseq::plot_ordination(Mserratus1, ord.nmds.bray_micro_s, color="Site1", title="Microcerotermes Bray NMDS ps.tr")
#M_sp_G
ord.nmds.bray_micro2 <- ordinate(MspG1, method="NMDS", distance="bray")
phyloseq::plot_ordination(MspG1, ord.nmds.bray_micro2, color="Site1", title="Microcerotermes Bray NMDS ps.tr")
